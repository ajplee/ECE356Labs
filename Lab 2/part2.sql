...
# Modify this file to achieve the requirements listed in Part 2 of the Lab 2
# specifications. Package it up with your part1.sql file using the provided
...
INSERT INTO Department(deptID, deptName, streetAddress, city, province, areaCode) VALUES(3, 'Marketing', '200 University Av W', 'Waterloo', 'ON', 'N2L3G1');
INSERT INTO Department(deptID, deptName, streetAddress, city, province, areaCode) VALUES(7, 'Research', '10 Victoria St A', 'Kitchener', 'ON', 'N2G1C5');
INSERT INTO Department(deptID, deptName, streetAddress, city, province, areaCode) VALUES(12, 'Software', '27 King College Cir', 'Toronto', 'ON', 'M5S5R5'); 
INSERT INTO Department(deptID, deptName, streetAddress, city, province, areaCode) VALUES(13, 'Computing', '1265 Military Trail', 'Scarborough', 'ON', 'M1C14A');
INSERT INTO Department(deptID, deptName, streetAddress, city, province, areaCode) VALUES(24, 'Training', '27 King College Cir', 'Toronto', 'ON', 'M5S5R5'); 
INSERT INTO Department(deptID, deptName, streetAddress, city, province, areaCode) VALUES(25, 'Human Resources', '1265 Military Trail', 'Scarborough', 'ON', 'M1C14A'); 
INSERT INTO Department(deptID, deptName, streetAddress, city, province, areaCode) VALUES(27, 'Food Services', '1265 Military Trail', 'Scarborough', 'ON', 'M1C14A'); 
...
INSERT INTO Assigned(empID,projID,roleID,start_date,end_date,assigned_status) VALUES(23, 345, 1,'2016-06-20',NULL,'active');
INSERT INTO Assigned(empID,projID,roleID,start_date,end_date,assigned_status) VALUES(66, 123, 1,'2016-08-25','2016-12-25','inactive');         
INSERT INTO Assigned(empID,projID,roleID,start_date,end_date,assigned_status) VALUES(77, 123, 2,'2015-01-03',NULL,'active');   
INSERT INTO Assigned(empID,projID,roleID,start_date,end_date,assigned_status) VALUES(45, 123, 3, '2015-02-03',NULL,'active');   
INSERT INTO Assigned(empID,projID,roleID,start_date,end_date,assigned_status) VALUES(89, 123, 3,'2017-02-03',NULL,'active'); 
INSERT INTO Assigned(empID,projID,roleID,start_date,end_date,assigned_status) VALUES(92, 345, 4,'2017-02-03',NULL,'active');  
INSERT INTO Assigned(empID,projID,roleID,start_date,end_date,assigned_status) VALUES(89, 345, 3,'2017-05-03',NULL,'active'); 
INSERT INTO Assigned(empID,projID,roleID,start_date,end_date,assigned_status) VALUES(92, 345, 5,'2017-01-03',NULL,'active'); 
INSERT INTO Assigned(empID,projID,roleID,start_date,end_date,assigned_status) VALUES(78, 345, 3,'2016-01-03','2017-01-03','inactive'); 
INSERT INTO Assigned(empID,projID,roleID,start_date,end_date,assigned_status) VALUES(79, 123, 5,'2016-01-03',NULL,'active');
