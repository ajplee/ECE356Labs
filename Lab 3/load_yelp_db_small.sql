...
LOAD DATA LOCAL INFILE '~/Downloads/test/yelp_data_business.csv' INTO TABLE Business # Imports the data from a CSV file into table Business. 
...
LOAD DATA LOCAL INFILE '~/Downloads/test/yelp_data_checkin.csv' INTO TABLE Checkin # Imports the data from a CSV file into table Checkin. 
															# You need to insert the path to file. Make sure to add ".csv" at the
                                                            # end of your files name. An example of path to file is
...
LOAD DATA LOCAL INFILE '~/Downloads/test/yelp_data_photo.csv' INTO TABLE Photo # Imports the data from a CSV file into table Photo. 
															# You need to insert the path to file. Make sure to add ".csv" at the
                                                            # end of your files name. An example of path to file is
...
LOAD DATA LOCAL INFILE '~/Downloads/test/yelp_data_review.csv' INTO TABLE Review # Imports the data from a CSV file into table Review. 
															# You need to insert the path to file. Make sure to add ".csv" at the
                                                            # end of your files name. An example of path to file is
...
LOAD DATA LOCAL INFILE '~/Downloads/test/yelp_data_tip.csv' INTO TABLE Tip # Imports the data from a CSV file into table Tip. 
															# You need to insert the path to file. Make sure to add ".csv" at the
                                                            # end of your files name. An example of path to file is
...
LOAD DATA LOCAL INFILE '~/Downloads/test/yelp_data_user.csv' INTO TABLE User_data # Imports the data from a CSV file into table User_data. 
															# You need to insert the path to file. Make sure to add ".csv" at the
                                                            # end of your files name. An example of path to file is
